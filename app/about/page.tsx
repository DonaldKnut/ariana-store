        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>
              ...
              and development. Oluwole&apos;s passion for education has led her
              to become a certified trainer, facilitator, and public speaker.
              She believes in the power of education to transform lives. Narnia
